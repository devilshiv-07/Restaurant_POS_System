    ...
    <div className='flex items-center gap-5 mb-2'>
      ...
      <div className='flex items-center justify-between w-[100%]'>
        <div className='flex flex-col items-start gap-1'>
            <h1 className='text-[#f5f5f5] text-lg font-semibold tracking-wide'>Devilshiv</h1>
            <p className='text-[#ababab] text-sm'>8 Items</p>
        </div>

        <div>
            <h1 className='text-[#f6b100] font-semibold border border-[#f6b100] p-1 rounded-lg'>Table No: 3</h1>
        </div>
